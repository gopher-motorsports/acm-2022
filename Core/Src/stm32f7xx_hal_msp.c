...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, ANLG_1_Pin|ANLG_2_Pin|ANLG_3_Pin|ANLG_5_Pin);

    HAL_GPIO_DeInit(GPIOA, DIG_1_Pin|ANLG_4_Pin|DIG_2_Pin|DRS_ISENSE_OUT_2_Pin);

    HAL_GPIO_DeInit(DRS_ISENSE_OUT_1_GPIO_Port, DRS_ISENSE_OUT_1_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF10     ------> ADC3_IN8
    */
    HAL_GPIO_DeInit(GPIOF, FRONT_ISENSE_OUT_R_Pin|FRONT_ISENSE_OUT_L_Pin);
